...
class ControllerSaleOrder extends Controller {
	private $error = array();
  	...
  	private function getList() {
		...
		if (isset($this->request->get['filter_western_union_name'])) {
			$filter_western_union_name = $this->request->get['filter_western_union_name'];
		} else {
			$filter_western_union_name = null;
		}
		
		if (isset($this->request->get['filter_western_union_pin'])) {
			$filter_western_union_pin = $this->request->get['filter_western_union_pin'];
		} else {
			$filter_western_union_pin = null;
		}
		...
		if (isset($this->request->get['filter_western_union_name'])) {
			$url .= '&filter_western_union_name=' . $this->request->get['filter_western_union_name'];
		}
		
		if (isset($this->request->get['filter_western_union_pin'])) {
			$url .= '&filter_western_union_pin=' . $this->request->get['filter_western_union_pin'];
		}
		...
		$data = array(
			...
			'filter_western_union_name' => $filter_western_union_name,
			'filter_western_union_pin' => $filter_western_union_pin,
		...
		$this->data['filter_western_union_name'] = $filter_western_union_name;
		$this->data['filter_western_union_pin'] = $filter_western_union_pin;
	...
	public function add_taobao_order() {
		
		$taobao_orders = $this->request->post['taobao_order'];
		$order_id = $this->request->get['order_id'];
		if (isset($this->request->get['order_id']) && !empty($taobao_orders) && count($taobao_orders) > 0)
		{
			$this->load->model('sale/order');
			$order_info = $this->model_sale_order->addTaobaoOrder($order_id, $taobao_orders);
		}
