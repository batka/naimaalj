...
function filter() {
	...
	var filter_western_union_name = $('input[name=\'filter_western_union_name\']').attr('value');
	
	if (filter_western_union_name) {
		url += '&filter_western_union_name=' + encodeURIComponent(filter_western_union_name);
	}
	
	var filter_western_union_pin = $('input[name=\'filter_western_union_pin\']').attr('value');
	
	if (filter_western_union_pin) {
		url += '&filter_western_union_pin=' + encodeURIComponent(filter_western_union_pin);
	}
