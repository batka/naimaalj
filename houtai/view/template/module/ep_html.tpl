        ...
        <div id="tab-module-<?php echo $module_row; ?>" class="vtabs-content">
          ...
          <div id="tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
            ...
            <tr>
                ...
                <td><input type="text" size="75" name="ep_html_module[<?php echo $module_row; ?>][heading][<?php echo $language['language_id']; ?>]" value="<?php echo isset($module['heading'][$language['language_id']]) ? $module['heading'][$language['language_id']] : ''; ?>" /></td>
              </tr>
              <tr>
                <td><?php echo $entry_description; ?></td>
                <td><textarea name="ep_html_module[<?php echo $module_row; ?>][description][<?php echo $language['language_id']; ?>]" id="description-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($module['description'][$language['language_id']]) ? $module['description'][$language['language_id']] : ''; ?></textarea></td>
              </tr>
            </table>
          </div>
          <?php } ?>
          <table class="form">
            <tr>
              ...
              <td><select name="ep_html_module[<?php echo $module_row; ?>][layout_id]">
            ...
            <tr>
              ...
              <td><select name="ep_html_module[<?php echo $module_row; ?>][box_status]">
            ...
            <tr>
              ...
              <td><select name="ep_html_module[<?php echo $module_row; ?>][status]">
            ...
            <tr>
              ...
              <td><input type="text" name="ep_html_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
            </tr>
          </table>
        </div>
        <?php $module_row++; ?>
...
function addModule() {	
	...
	html += '          <td><input type="text" size="75" name="ep_html_module[' + module_row + '][heading][<?php echo $language['language_id']; ?>]" value=""/></td>';
	html += '        </tr>';
	html += '        <tr>';
	html += '          <td><?php echo $entry_description; ?></td>';
	html += '          <td><textarea name="ep_html_module[' + module_row + '][description][<?php echo $language['language_id']; ?>]" id="description-' + module_row + '-<?php echo $language['language_id']; ?>"></textarea></td>';
	html += '        </tr>';
	html += '      </table>';
	html += '    </div>';
	<?php } ?>
	...
	html += '      <td><select name="ep_html_module[' + module_row + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	...
	html += '      <td><select name="ep_html_module[' + module_row + '][box_status]">';
	...
	html += '      <td><select name="ep_html_module[' + module_row + '][status]">';
	html += '        <option value="1"><?php echo $text_enabled; ?></option>';
	html += '        <option value="0"><?php echo $text_disabled; ?></option>';
	html += '      </select></td>';
	html += '    </tr>';
	...
	html += '      <td><input type="text" name="ep_html_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
	html += '    </tr>';
	html += '  </table>'; 
	html += '</div>';
