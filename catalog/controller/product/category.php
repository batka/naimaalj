...
class ControllerProductCategory extends Controller {  
	public function index() { 
		...
		if ($category_info) {
			...
			if (list($sub_categories, $items, $product_total) = $CallTaobao->Items($data)) {
				...
				$this->data['text_error'] = "Search result was empty!";
			}
			...
			/*	
      <option value="price:desc">(¼Û¸ñ´Ó¸ßµ½µÍ)</option>
      <option value="price:asc">(¼Û¸ñ´ÓµÍµ½¸ß)</option>
      <option value="seller_credit:desc">(ÐÅÓÃµÈ¼¶´Ó¸ßµ½µÍ)</option>
      <option value="volume:desc">(³É½»Á¿³É¸ßµ½µÍ) </option>
      <option value="volume:asc">(³É½»Á¿´ÓµÍµ½¸ß</option>
	  */
			$this->data['sorts'][] = array(
